...
Singleton {
    ...
    property bool popupInhibited: (GlobalStates?.sidebarRight?.opened ?? false) || silent
            ...
            if (!root.popupInhibited) {
                ...
                if (notification.expireTimeout != 0) {
                    newNotifObject.timer = notifTimerComponent.createObject(root, {
                        ...
                        "interval": notification.expireTimeout < 0 ? 7000 : notification.expireTimeout, // was notifications.timeout
                    });
                }
                root.unread++;
            }
