...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "easyEffects", "nightLight", "darkMode", "gameMode", "screenSnip", "colorPicker", "mic", "audio", "notifications", "powerProfile", "musicRecognition"]
