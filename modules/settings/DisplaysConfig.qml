                ...
                GridLayout {
                    ...
                    ContentSubsection {
                        ...
                        StyledComboBox {
                            ...
                            onActivated: (index) => {
                                return card.selRefresh = card.refreshes[index];
                            }
                        }
                    ...
                    ContentSubsection {
                        ...
                        StyledComboBox {
                            ...
                            currentIndex: {
                                const i = card.scaleOptions.findIndex((o) => {
                                    return o.value === card.selScale;
                                });
                                return i !== -1 ? i : 1;
                            }
                            onActivated: (index) => {
                                return card.selScale = card.scaleOptions[index].value;
                            }
                        }
                    ...
                    ContentSubsection {
                        ...
                        StyledComboBox {
                            ...
                            currentIndex: Math.max(0, card.transformOptions.findIndex((o) => {
                                return o.value === card.selTransform;
                            }))
                            onActivated: (index) => {
                                return card.selTransform = card.transformOptions[index].value;
                            }
                        }
                    ...
                    ContentSubsection {
                        ...
                        StyledComboBox {
                            ...
                            currentIndex: Math.max(0, card.mirrorOptions.findIndex((o) => {
                                return o.value === card.selMirror;
                            }))
                            onActivated: (index) => {
                                return card.selMirror = card.mirrorOptions[index].value;
                            }
                        }
